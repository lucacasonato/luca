...
const Home: NextPage<Props> = ({ blogArticles }) => {
  return (
    <div className="mx-auto max-w-screen-md px-4 sm:px-6 md:px-8 my-12 sm:my-20 md:my-32">
      ...
      <div className="mt-10 text-lg leading-7 text-gray-900">
        ...
        . I like Go, TypeScript, Rust, Kubernetes and fast websites. I actively
        contribute to the{" "}
      ...
      <div className="mt-10 flex">
        ...
        <a
          ...
          className="ml-2 text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out"
        >
      ...
      <h3 className="mt-16 text-2xl font-medium">Blog</h3>
      <ol className="mt-4 text-lg leading-7 text-gray-900">
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  return {
    props: {
      blogArticles: posts.results.map((post) => ({
        id: post.uid,
